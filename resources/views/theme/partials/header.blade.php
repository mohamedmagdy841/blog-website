    ...
    <div class="main_menu">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container box_1620">
                ...
                <a class="navbar-brand logo_h" href="{{ route("theme.index") }}"><img src="{{ asset("assets")}}/img/logo.png" alt=""
                                                                                      class="img-fluid" style="max-width: 100px; max-height: 50px;"></a>
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    ...
                    @auth()
                        <li class="nav-item submenu dropdown">
                            <a href="#" class="nav-link dropdown-toggle ml-3" data-toggle="dropdown" role="button" aria-haspopup="true"
                               aria-expanded="false">{{ Auth::user()->name }}</a>
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a class="nav-link" href="{{ route("blog.myBlogs") }}">My Blogs</a></li>
                                <li class="nav-item">
